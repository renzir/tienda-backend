...
const verificarOrder = require("../../middleware/verificarOrder");
...
const verficarOrderIDParams = require("../../middleware/verficarOrderIDParams");
const verficarOrderProductIDParams = require("../../middleware/verficarOrderProductIDParams");
